              ...
              <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                ...
                <div className="flex-1 space-y-3">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
                    ...
                    <div
                      className={`p-2.5 rounded-lg flex flex-col justify-between min-h-[68px] ${Number(servicio.saldo_pendiente) > 0 ? "bg-warning/5 border border-warning/20" : "bg-success/5 border border-success/20"}`}
                    >
                      ...
                      return (
                        <div className={`p-2.5 rounded-lg flex flex-col justify-between min-h-[68px] ${s.box}`}>
                          ...
                          <div>
                            ...
                            <p className={`text-[10px] font-medium ${s.text}`}>{g.margen.toFixed(1)}% margen</p>
                          </div>
                        </div>
                      )
                    })()}
